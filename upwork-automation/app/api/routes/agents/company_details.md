...
tech_stack: [Vanna AI, Next.js, Tailwind, Prisma, Clerk, MySQL, GPT-5, Shadcn, APEX Chart, Vercel AI SDK, Qdrant, Azure OpenAI]
ai_capabilities: [Vanna AI, GPT-5, Vercel AI SDK, Azure OpenAI, Function/Tool Calling to connect databases and render data as graphs, tables, or text]
...
tech_stack: [Next.js, React, Tailwind CSS, Node.js, Supabase, Ship AI Fast Boilerplate, Stripe, OpenAI, GPT-5]
ai_capabilities: [LLM (GPT-5), AI-powered interaction with Business Analysis documents, AI-assisted Requirements Gathering & Analysis]
